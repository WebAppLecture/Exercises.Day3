...
%
\par Sie können Aufgabe 12 durch Einbau einer Textbox über \htag{textarea}
...
darstellt.
\item
Beim \jvar{onsubmit} des Formulars erstellen Sie über \jfunc{createElement} ein
neues Script-Element.
\item
Dieses Script Element soll folgenden \jvar{innerHTML} Wert erhalten (\jvar{tai}
